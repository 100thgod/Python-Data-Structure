class BST(object):
    ...
    This BST support insert, find, and delete-min operations.
    ...
    def __init__(self):
        self.root = None
    def insert(self, t):
        """ Insert key t into this BST, modify it in-palce."""
        new = BSTnode(t)
    ...
    def find(self, t):
        """Return the node for key t id is in the tree, or None otherwise."""
        node= self.root
    ...
    def delete_min(self):
        ...
        if self.root is None:
            ...
            while node.left is not None:
                node= node.left 
            # Remove that node and promaote its right subtree.
